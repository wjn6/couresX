...
<body>
    ...
    <div id="userinfo" class="layui-padding-1" style="display:none;">
        ...
        <div v-if="home_top_notice_open" class="layui-panel layui-padding-2"
            style="margin-bottom: 5px; white-space: nowrap; display: flex; align-items: center; overflow: hidden; height: 19px;">
            <i class="layui-icon layui-icon-speaker"
                style="border-right: 1px solid #c5afaf; padding-right: 4px; margin-right: 6px;color: inherit;"></i>
                        ...
                        <div class="layui-panel " style="height: 100%;">
                            ...
                            <div class="userinfo_top">
                                <div style="position: absolute; right: 3px; top: 3px; color: #aaaaaa;">
                                    <el-button circle size="small" text title="个人信息设置" lay-href="userinfo"
                                        lay-text="个人信息">
                                        <el-icon>
                                            <Setting />
                                        </el-icon>
                                    </el-button>
                                    <el-button title="点击刷新个人数据" text bg size="small" style="padding: 6px;margin: 0;"
                                        @click="userinfo">
                                ...
                                <div>
                                    <img style="border-radius:50%;width:auto;height: 40px;cursor: pointer;"
                                        ...
                                        alt="<?= $userrow['name']; ?>"
                                        @click="photosView(1,[{alt:<?= $userrow['name']; ?>,pid:1,src:'https://q1.qlogo.cn/g?b=qq&nk='+(<?= $userrow['qq']; ?>?<?= $userrow['qq']; ?>:<?= $userrow['user']; ?>)+'&s=100'}])">
                                </div>
                                <div>
                                    ...
                                    <div class="layui-font-12"
                                        style="top: 0; position: relative;scale: .8; transform-origin: left;white-space: nowrap;">
                                        <el-tag type="success"
                                            style="padding: 0 6px;margin-right:3px;margin-bottom:3px;">
                                            UID：{{row.uid}}
                                        </el-tag>
                                        <el-tag type="primary"
                                            style="padding: 0 6px;margin-right:3px;margin-bottom:3px;">
                            ...
                            <div class="userinfo_bottom">
                                <el-timeline>
                                    <el-timeline-item :hollow="true">
                                        <div
                                            style="display: flex; align-items: center; justify-content: space-between; overflow-x: hidden; white-space: nowrap;">
                                            <div>
            ...
            <el-col :xs="24" :sm="12" class="el-row_col-b2">
                <el-row :gutter="5">
                    ...
                    <el-col :xs="24" :sm="24" class="el-row_col-b2">
                        <el-row :gutter="5">
                            <?php if ($userrow["uid"] == 1) { ?>
                                <div lay-href="XCharts" lay-text="XCharts" title="XCharts"
                                    style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); z-index: 1; background: #ffffff; border-radius: 50%; width: 50px; height: 50px; display: flex; align-items: center; justify-content: center;box-shadow: 0px 12px 32px 4px rgba(0, 0, 0, .04), 0px 8px 20px rgba(0, 0, 0, .08);cursor: pointer;">
                                    <el-icon class="animate__animated animate__jello infinite"
                                        :size="18"><pie-chart /></el-icon>
                                </div>
                            <?php } ?>
                            <el-col :xs="12" :sm="12">
                                <div class="layui-panel">
                                    ...
                                    <div class="layui-card-body"
                                        ...
                                        <div class="layui-hide-xs">
                                            <el-progress type="circle" :percentage="
                                                progressOK?( isNaN(row.money/row.zcz)?0:row.money/row.zcz * 100).toFixed(2):0
                            ...
                            <el-col :xs="12" :sm="12">
                                <div class="layui-panel">
                                    ...
                                    <div class="layui-card-body"
                                        ...
                                        <div class="layui-hide-xs">
                                            <el-progress type="circle" :percentage="progressOK?((isNaN(row.dd.today / row.dd.total)?0:row.dd.today / row.dd.total)*100).toFixed(2):0" width="60" :stroke-width="4">
                            ...
                            <el-col :xs="12" :sm="12">
                                <div class="layui-panel">
                                    ...
                                    <div class="layui-card-body"
                                        ...
                                        <div>
                                            <h3 style="margin-bottom: 5px;">
                                                {{ progressOK?(isNaN(<?= $userrow['xd'] ?> /
                                                <?= $userrow['xd'] + $userrow['ck'] ?> )?0:(<?= $userrow['xd'] ?> /
                                                <?= $userrow['xd'] + $userrow['ck'] ?>*100).toFixed(2)):0 }} %
                                            </h3>
                                            <div class="layui-font-gray layui-font-12">
                                        ...
                                        <div class="layui-hide-xs">
                                            <el-progress type="circle"
                                                :percentage="progressOK?isNaN(<?= $userrow['xd'] ?> / <?= $userrow['xd'] + $userrow['ck'] ?>  )?0:(<?= $userrow['xd'] ?> / <?= $userrow['xd'] + $userrow['ck'] ?>*100).toFixed(2):0"
                                                width="60" :stroke-width="4"></el-progress>
                                        </div>
                                    </div>
                                </div>
            ...
            <el-col :xs="24" :sm="12">
                <div class="layui-panel">
                    <div class="layui-card-header cl_position">
                        <div
                            style="display: inline-flex; align-items: center; justify-content: left; gap: 2px;position: relative;">
                            <i class="layui-icon layui-icon-notice "></i>
                            &nbsp;实时公告<el-button title="点击刷新" text bg size="small" style="padding: 6px;"
                                @click="homenotice_get"><el-icon>
                                    <Refresh />
                                </el-icon></el-button>
                        </div>
                        <span v-if="uid" style="float:right;">
                            &nbsp;<button class="layui-btn layui-btn-xs layui-bg-blue"
                                @click="homenotice_set">管理公告</button>
                        </span>
                    </div>
                    <div class="layui-card-body"
                        style="height: 300px !important; overflow-y: auto; word-wrap: break-word; word-break: normal;">
                                ...
                                <template v-else>
                                    <div v-for="(item,key) in homenotice" :key="key">
                                        <div
                                            ...
                                            <p>
                                                <button type="button"
                                                    class="layui-btn layui-btn-primary layui-btn-xs layui-font-green"
                                                    style="border: 0;"><i
                                                        class="layui-icon layui-icon-eye"></i>{{item.readUIDS}}</button>
                                            </p>
                                        </div>
                                        ...
                                        <div class="layui-font-12"
                                            style="display: flex; align-items: center; scale: 0.8; transform-origin: left center;">
                                            <p v-if="Number(item.top)">

                                                <button type="button"
                                                    class="layui-btn layui-btn-xs layui-bg-blue">置顶</button>
                                            </p>&nbsp;&nbsp;
                                            <p>
                                                <button type="button"
                                                    class="layui-btn layui-btn-xs">{{item.author}}</button>
                                            </p>&nbsp;&nbsp;
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="layui-font-12">
                                            <p>
                                            <div class="marquee1"
                                                style="background: #f56c6c; color: #ffffff; padding: 1px 5px; border-radius: 3px;">
                                                <span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                ...
                                                <el-tag type="info" effect="light" round>
                                                    <svg t="1730034725653" class="icon" viewBox="0 0 1024 1024"
                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6609"
                                                        id="mx_n_1730034725654" width="11" height="11">
                                                        <path
                                                            d="M472.234667 123.733333v827.605334L382.037333 1024V335.530667H212.266667L472.234667 123.733333zM637.184 0v672.725333h174.549333l-264.533333 217.130667V62.677333L637.226667 0z"
                                                            fill="#000000" p-id="6610"></path>
                                                    </svg> Axios
                                                </el-tag>
                                                <el-tag type="info" effect="light" round>
                                                ...
                                                <el-tag type="info" effect="light" round>
                                                    <svg t="1730034851194" class="icon" viewBox="0 0 1024 1024"
                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7618"
                                                        width="11" height="11">
                                                        <path
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <el-link type="primary"
                                                @click="window.open('https://github.com/time-demon/couresX')">
                                                <i class="layui-icon layui-icon-github"></i>
                                                https://github.com/time-demon/couresX
                                            </el-link>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="layui-table font12Table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>PHP版本</td>
                                        <td>
                                            <i class="fa-brands fa-php"></i> <?php echo PHP_VERSION ?>&nbsp;<el-button text
                                                bg size="small" @click="open_phpinfo">phpinfo</el-button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Mysql版本</td>
                                        <td><i class="fa-solid fa-database"></i>
                                            <?= str_replace('-log', '', $DB->get_row("select VERSION() as version")["version"]); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>操作系统</td>
